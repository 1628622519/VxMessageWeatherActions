...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wx1da028a78bb64819";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "a19c65829ed0b3569aea7eb7a29a40cb";
    ...
    static {
        userList.add(getUser(
                "op3uV6kOCy3N7M3KfuNdPpAPqPtI", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "aGMwq0dYpKJD4Z9oXGPfb5KhtsMDM3sKZb6CfyKDIC0", //要给这个人发送的模板ID
                "宝宝", //咋称呼这个人
                "浙江省温州市瓯海区", //这个人的详细地址
                "温州", //这个人在的城市
                new BirthDay(2003,10,1,false,false,"宝宝生日快乐！！"),
                new BirthDay(2004,1,5,true,false,"生日快乐哦~~"),
                new BirthDay(2023,3,31,false,true),
                new BirthDay(2023,3,31,false,false,"周年快乐！！！")
        ));

        userList.add(getUser(
                "op3uV6h3gL7aSrQgDiUcAP6KQf90",
                "woBxWLrTWH9gami4z9_8vdb_XAQLKYFS_Xanw6u-2Cc",
                "任总",
                "浙江省温州市瓯海区", //这个人的详细地址
                "温州", //这个人在的城市
                new BirthDay(2003,10,1,false,false,"宝宝生日快乐！！"),
